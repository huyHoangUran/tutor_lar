...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 08:22:38 GMT -->
...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('assets') }}/css/demo1.min.css">
...
<body>
                                ...
                                <ul class="contact-info m-b-4">
                                    ...
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a
                                            href="https://portotheme.com/cdn-cgi/l/email-protection#274a464e4b67425f464a574b420944484a"><span
                                                class="__cf_email__"
                                                data-cfemail="3c515d55507c59445d514c5059125f5351">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
                    ...
                    <div class="footer-right ml-auto mt-1 mt-sm-0">
                        <div class="payment-icons">
                            ...
                            <span class="payment-icon paypal"
                                style="background-image: url({{ asset('assets') }}/images/payments/payment-paypal.svg)"></span>
                            <span class="payment-icon stripe"
                                style="background-image: url({{ asset('assets') }}/images/payments/payment-stripe.png)"></span>
                            <span class="payment-icon verisign"
                                style="background-image:  url({{ asset('assets') }}/images/payments/payment-verisign.svg)"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        (function() {
            var js =
                "window['__CF$cv$params']={r:'82242a170d943f6b',t:'MTY5OTM0NTMwNS4xMzEwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/b/scripts/jsd/61b90d1d/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 08:22:56 GMT -->
