                ...
                <div class="col-lg-9">
                    ...
                    'nav': false
                        ...
                        <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #2699D0;"
                                src="{{ asset('assets') }}/images/demoes/demo1/slider/slide-1.png" width="880"
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #dadada;"
                                src="{{ asset('assets') }}/images/demoes/demo1/slider/slide-2.jpg" width="880"
                                height="428" alt="home-slider">
                        ...
                        <div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw  d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #e5e4e2;"
                                src="{{ asset('assets') }}/images/demoes/demo1/slider/slide-3.jpg" width="880"
                                height="428" alt="home-slider" />
                            <div class="banner-layer text-uppercase appear-animate" data-animation-name="fadeInUpShorter">
                    ...
                    'responsive': {
                        ...
                        <div class="banner banner1 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('assets') }}/images/demoes/demo1/banners/banner-1.jpg"
                        ...
                        <div class="banner banner2 text-uppercase banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('assets') }}/images/demoes/demo1/banners/banner-2.jpg"
                                    style="background-color: #dadada;" alt="banner">
                            </figure>
                        ...
                        <div class="banner banner3 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('assets') }}/images/demoes/demo1/banners/banner-3.jpg"
                                    style="background-color: #dadada;" alt="banner">
                            </figure>
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small m-b-1 pb-1 appear-animate"
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-1.jpg"
                                        width="205" height="205" alt="product">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-1-2.jpg"
                                        width="205" height="205" alt="product">
                                </a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title"> <a href="demo1-product.html">Black Grey Headset</a>
                                </h3>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-2.jpg"
                                        width="205" height="205" alt="product" />
                                </a>
                                <div class="btn-icon-group">
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-3.jpg"
                                        width="205" height="205" alt="product">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-3-2.jpg"
                                        width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-4.jpg"
                                        width="205" height="205" alt="product">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-4-2.jpg"
                                        width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-5.jpg"
                                        width="205" height="205" alt="product">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/products/product-5-2.jpg"
                                        width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                    ...
                    'responsive': {
                        ...
                        <img src="{{ asset('assets') }}/images/brands/small/brand1.png" width="140" height="60"
                            alt="brand">
                        <img src="{{ asset('assets') }}/images/brands/small/brand2.png" width="140" height="60"
                            alt="brand">
                        <img src="{{ asset('assets') }}/images/brands/small/brand3.png" width="140" height="60"
                            alt="brand">
                        <img src="{{ asset('assets') }}/images/brands/small/brand4.png" width="140" height="60"
                            alt="brand">
                        <img src="{{ asset('assets') }}/images/brands/small/brand5.png" width="140" height="60"
                            alt="brand">
                        <img src="{{ asset('assets') }}/images/brands/small/brand6.png" width="140" height="60"
                            alt="brand">
                    </div>
                    <!-- End .brands-slider -->
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                            ...
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-4.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-4-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-5.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-5-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-6.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-6-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                            ...
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="demo1-product.html">Battery
                                                Charger</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-7.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-7-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-8.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-8-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="demo1-product.html">Casual Note
                                                Bag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                            ...
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-9.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-9-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-10.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-10-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-11.jpg"
                                                width="84" height="84" alt="product">
                                            <img src="{{ asset('assets') }}/images/demoes/demo1/products/small/product-11-2.jpg"
                                                width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                    ...
                    <div class="widget widget-banners px-3 pb-3 text-center">
                        <div class="owl-carousel owl-theme dots-small">
                            ...
                            <div class="banner banner4">
                                <figure>
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/banners/banner-7.jpg"
                                        alt="banner">
                                </figure>
                            ...
                            <div class="banner banner5">
                                ...
                                <figure class="m-b-3">
                                    <img src="{{ asset('assets') }}/images/demoes/demo1/banners/banner-8.jpg"
                                        alt="banner">
                                </figure>
                        ...
                        <div class="owl-carousel owl-theme dots-left dots-small">
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('assets') }}/images/clients/client-1.jpg" alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('assets') }}/images/clients/client-2.jpg" alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('assets') }}/images/clients/client-3.jpg" alt="client">
                                    </figure>
                          ...
                          'loop': false }">
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('assets') }}/images/blog/home/post-1.jpg"
                                            data-zoom-image="{{ asset('assets') }}/images/blog/home/post-1.jpg"
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('assets') }}/images/blog/home/post-2.jpg"
                                            data-zoom-image="{{ asset('assets') }}/images/blog/home/post-2.jpg"
                                            width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('assets') }}/images/blog/home/post-3.jpg"
                                            data-zoom-image="{{ asset('assets') }}/images/blog/home/post-3.jpg"
                                            width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
