    ...
    <div class="topbar container-fluid">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('layouts/assets/images/flags/us.jpg') }}" alt="user-image" class="me-0 me-sm-1"
                        height="12">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('layouts/assets/images/flags/germany.jpg') }}" alt="user-image"
                            class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('layouts/assets/images/flags/italy.jpg') }}" alt="user-image" class="me-1"
                            height="12">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('layouts/assets/images/users/avatar-1.jpg') }}"
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="account-user-avatar">
                        <img src="{{ asset('layouts/assets/images/users/avatar-1.jpg') }}" alt="user-image"
